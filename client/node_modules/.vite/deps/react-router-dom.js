import {
  require_react_dom
} from "./chunk-MDQECI6I.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-YR5L6HE3.js";
...
function getRouteInstrumentationUpdates(fns, route) {
  ...
  ["loader", "action"].forEach((key) => {
    ...
    if (typeof handler === "function" && aggregated[key].length > 0) {
      let original = (_a = handler[UninstrumentedSymbol]) != null ? _a : handler;
  ...
  if (route.middleware && route.middleware.length > 0 && aggregated.middleware.length > 0) {
    updates.middleware = route.middleware.map((middleware) => {
      var _a;
      let original = (_a = middleware[UninstrumentedSymbol]) != null ? _a : middleware;
      let instrumented = wrapImpl(
...
function instrumentClientSideRouter(router2, fns) {
  ...
  if (aggregated.navigate.length > 0) {
    let navigate = (_a = router2.navigate[UninstrumentedSymbol]) != null ? _a : router2.navigate;
    let instrumentedNavigate = wrapImpl(
      ...
      (...args) => {
        ...
        return {
          ...
          ...getRouterInfo(router2, opts != null ? opts : {})
        };
      }
    );
  ...
  if (aggregated.fetch.length > 0) {
    let fetch2 = (_b = router2.fetch[UninstrumentedSymbol]) != null ? _b : router2.fetch;
    let instrumentedFetch = wrapImpl(aggregated.fetch, fetch2, (...args) => {
      let [key, , href2, opts] = args;
      return {
        href: href2 != null ? href2 : ".",
        fetcherKey: key,
        ...getRouterInfo(router2, opts != null ? opts : {})
      };
    });
...
function createRouter(init) {
    ...
    [...subscribers].forEach(
      (subscriber) => {
        ...
        return subscriber(state, {
          ...
          newErrors: (_a = newState.errors) != null ? _a : null,
  ...
  async function startNavigation(historyAction, location2, opts) {
    ...
    let matches = (opts == null ? void 0 : opts.initialHydration) && state.matches && state.matches.length > 0 && !initialMatchesIsFOW ? state.matches : matchRoutes(routesToUse, location2, basename);
    let flushSync3 = (opts && opts.flushSync) === true;
            ...
            let res = await generateMiddlewareResponse(
              async (revalidationRequest, opts2 = {}) => {
                ...
                let result2 = await queryImpl(
                  ...
                  null,
                  "filterMatchesToLoad" in opts2 ? (_a = opts2.filterMatchesToLoad) != null ? _a : null : filterMatchesToLoad != null ? filterMatchesToLoad : null,
...
function isSameRoute(newRoute, existingRoute) {
  ...
  return (_b = (_a = newRoute.children) == null ? void 0 : _a.every(
    (aChild, i) => {
      var _a2;
...
async function callRouteMiddleware(args, middlewares, handler, processResult, isResult, errorHandler, idx = 0) {
  ...
  let { request } = args;
  if (request.signal.aborted) {
    throw (_a = request.signal.reason) != null ? _a : new Error(`Request aborted: ${request.method} ${request.url}`);
  }
  ...
  try {
    ...
    if (isResult(result)) {
      ...
      return result != null ? result : nextResult.value;
    } else {
...
function dataWithResponseInitToResponse(data2) {
  var _a;
  return Response.json(data2.data, (_a = data2.init) != null ? _a : void 0);
}
function dataWithResponseInitToErrorResponse(data2) {
  var _a, _b, _c, _d;
  return new ErrorResponseImpl(
    (_b = (_a = data2.init) == null ? void 0 : _a.status) != null ? _b : 500,
    (_d = (_c = data2.init) == null ? void 0 : _c.statusText) != null ? _d : "Internal Server Error",
    data2.data
  );
}
...
function useRoute(...args) {
  ...
  const id = (_a = args[0]) != null ? _a : currentRouteId;
  ...
  return {
    ...
    actionData: (_b = state.actionData) == null ? void 0 : _b[id]
  };
}
var alreadyWarned2 = {};
        ...
        Object.values(newErrors).forEach(
          (error) => {
            ...
            return onError(error, {
              ...
              params: (_b = (_a = newState.matches[0]) == null ? void 0 : _a.params) != null ? _b : {},
...
function encode(input, options) {
  const { plugins, postPlugins, signal, onComplete } = options != null ? options : {};
  const encoder3 = {
    deferred: {},
    index: 0,
...
function Links({ nonce, crossOrigin }) {
  ...
  return React8.createElement(React8.Fragment, null, typeof criticalCss === "string" ? React8.createElement(
    ...
    ({ key, link }) => {
      var _a, _b;
      return isPageLinkDescriptor(link) ? React8.createElement(
        PrefetchPageLinks,
        {
          key,
          nonce,
          ...link,
          crossOrigin: (_a = link.crossOrigin) != null ? _a : crossOrigin
        }
        ...
        "link",
        {
          ...
          nonce,
          ...link,
          crossOrigin: (_b = link.crossOrigin) != null ? _b : crossOrigin
        }
      );
    }
  ));
  ...
  return React8.createElement(React8.Fragment, null, dataHrefs.map((href2) => React8.createElement("link", { key: href2, rel: "prefetch", as: "fetch", href: href2, ...linkProps })), moduleHrefs.map((href2) => React8.createElement("link", { key: href2, rel: "modulepreload", href: href2, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => {
    ...
    return React8.createElement(
      "link",
      {
        ...
        ...link,
        crossOrigin: (_a = link.crossOrigin) != null ? _a : linkProps.crossOrigin
      }
    );
  }));
}
...
try {
  if (isBrowser2) {
    window.__reactRouterVersion = "7.13.2";
  }
} catch (e) {
}
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    try {
      reason = renderError != null ? renderError : reason;
...
function RSCStaticRouter({ getPayload }) {
  ...
  const context = {
    get _deepestRenderedBoundaryId() {
      var _a;
      return (_a = decoded._deepestRenderedBoundaryId) != null ? _a : null;
    },
...
function HydratedRouter(props) {
  ...
  return React23.createElement(React23.Fragment, null, React23.createElement(
    FrameworkContext.Provider,
    {
      value: {
